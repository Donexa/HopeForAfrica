...
function Value({ title, paragraphs, link }) {
    return <div className="section_header no_vsb">
        <h4>{title}</h4>
        <div className="section_header_contenair flex">
            <div>{paragraphs.map(_ => <p>{_}</p>)}</div>
...
function OurValues() {
    ...
    return <React.Fragment>
        ...
        {
            Data.map(_ => <Value key={_.title} {..._} />)
        }
    </React.Fragment>
}
...
function Trustee({ name }) {
    return <div className="trustee flex">
...
function OurTrustees() {
    ...
    return <React.Fragment>
        {
            Data.map(_ => <Trustee key={_.name} {..._} />)
        }
    </React.Fragment>
}
...
function OurTeam({ name, post, image }) {
    return <div className="our_team flex">
...
function OurTeams() {
    ...
    return <React.Fragment>
        {
            Data.map(_ => <OurTeam key={_.name} {..._} />)
        }
    </React.Fragment>
}
